package net.decentr.module_decentr_staking.presentation.views.tablefixheaders;
...
import net.decentr.module_decentr_staking.presentation.views.tablefixheaders.adapters.TableAdapter;
...
public class TableFixHeaders extends ViewGroup {
	...
	private ActualYListener actualYListener;
	...
	public void setActualYListener(ActualYListener actualYListener) {
		this.actualYListener = actualYListener;
	}
	...
	public void scrollBy(int x, int y) {
		...
		if (actualYListener != null) {
			actualYListener.onEvent(scrollY);
		}
