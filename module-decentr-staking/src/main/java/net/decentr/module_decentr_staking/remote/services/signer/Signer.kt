...
object Signer {
    ...
    val COSMOS_GAS_AMOUNT_EXIT_POOL = BigDecimal("300000")
    val mSelectedGasRate = BigDecimal("0.00025")

    fun getClaimRewardsMsg(
        toValAddresses: ArrayList<String?>,
        delegatorAddress: String
    ): ArrayList<com.google.protobuf.Any> {
        val msgAnys = ArrayList<com.google.protobuf.Any>()
        for (valAddr in toValAddresses) {
            ...
            val msgClaimRewardAny: com.google.protobuf.Any = com.google.protobuf.Any.newBuilder()
    ...
    fun getReDelegateMsg(
        ...
        msgAnys.add(
            com.google.protobuf.Any.newBuilder().setTypeUrl("/cosmos.staking.v1beta1.MsgBeginRedelegate")
    ...
    fun getUnDelegateMsg(
        ...
        msgAnys.add(
            com.google.protobuf.Any.newBuilder().setTypeUrl("/cosmos.staking.v1beta1.MsgUndelegate")
    ...
    fun getDelegateMsg(
        ...
        msgAnys.add(
            com.google.protobuf.Any.newBuilder().setTypeUrl("/cosmos.staking.v1beta1.MsgDelegate")
    ...
    fun getSignTx(
        ...
        msgAnys: ArrayList<com.google.protobuf.Any>,
        fee: Fee,
        memo: String?,
        pKey: ECKey,
        chainId: String?,
    ...
    private fun getGrpcTxBodys(
        msgsAny: ArrayList<com.google.protobuf.Any>,
        memo: String?
    ): TxBody? {
    ...
    private fun getGrpcSignerInfo(
        ...
        val pubKey: com.google.protobuf.Any? = generateGrpcPubKeyFromPriv(
            auth,
            publicKey
        )
        val singleMode =
    ...
    private fun generateGrpcPubKeyFromPriv(
        ...
        return com.google.protobuf.Any.newBuilder().setTypeUrl("/cosmos.crypto.secp256k1.PubKey")
...
//        }
    ...
    fun isValidateDelegateAmount(amount: String): Coin {
        try {
            ...
            if (amountTemp.compareTo(BigDecimal.ZERO) <= 0) throw IllegalStateException("Amount cannot be 0")
