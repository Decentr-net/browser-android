...
class CameraSource(private val graphicOverlay: GraphicOverlay) {
    ...
    private fun setPreviewAndPictureSize(camera: Camera, parameters: Parameters) {
        ...
        val sizePair: CameraSizePair = getUserSpecifiedPreviewSize(context) ?: run {
        ...
        previewSize = sizePair.preview.also {
            ...
            saveStringPreference(context, "rcpvs", it.toString())
        }
    ...
    private fun saveStringPreference(context: Context, @StringRes prefKeyId: Int, value: String?) {
    ...
    private fun saveStringPreference(context: Context, key: String, value: String?) {
        PreferenceManager.getDefaultSharedPreferences(context)
            .edit()
            .putString(key, value)
            .apply()
    ...
    private fun getUserSpecifiedPreviewSize(context: Context): CameraSizePair? {
        return try {
